...
public class PlayerMovement : MonoBehaviour
{
    ...
    // void bounce()
    // {
    //     if((!myCollider.IsTouchingLayers(LayerMask.GetMask("Bouncing"))))
    //     {
    //         return;
    //     }
    //     rigidBody.velocity = new Vector2 (moveInput.x * playerSpeed, bounceSpeed);
    // }
    ...
    {
        if(isAlive && (myCollider.IsTouchingLayers(LayerMask.GetMask("Enemy", "Hazards"))))
        {
            Die();
        }
    }
